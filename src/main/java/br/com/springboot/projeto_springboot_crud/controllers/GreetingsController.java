package br.com.springboot.projeto_springboot_crud.controllers;
...
import br.com.springboot.projeto_springboot_crud.repository.UsuarioRepository;
...
public class GreetingsController {
    ...
    @GetMapping(value = "listatodos") //metodo da API Listar
    ...
    public ResponseEntity<?> atualizar (@RequestBody Usuario usuario){ // recebe os dados para atualizar
    	...
    	if(usuario.getId() == null) {
        	return new ResponseEntity<String>("Id não foi informado, digite o ID", HttpStatus.OK);
